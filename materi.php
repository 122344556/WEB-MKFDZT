...
<body>
    <div class="navbar" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
        <a href="index.php"><div class="brand">Makhfudzat</div></a>
        <div class="logo">
    ...
    <div class="center-text" ">
        <div class="left-text data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000"">
            <h1 class="tengah">Makhfudzat Matsal</h1>
        </div>

        <div class="right-text">
            <p>
                Ma'khudzot (Mazmur) Matsal adalah salah satu bentuk ilmu balaghah (ilmu retorika atau sastra) dalam bahasa Arab. Kata "Ma'khudzot" 
                berasal dari akar kata "khadza", yang berarti "mengambil" atau "diambil". Sementara itu, "Matsal" berarti "contoh" atau "metafora". 
                Jadi, secara harfiah, Ma'khudzot Matsal dapat diartikan sebagai "contoh yang diambil" atau "metafora yang diambil".
                Dalam konteks retorika Arab atau sastra Arab, Ma'khudzot Matsal merujuk pada suatu ungkapan atau perumpamaan yang diambil dari 
                realitas atau kenyataan sehari-hari untuk memberikan pemahaman atau gambaran tentang suatu konsep atau gagasan. Metafora ini biasanya 
                digunakan untuk menjelaskan konsep-konsep abstrak dengan cara yang lebih konkret dan mudah dipahami oleh pendengar atau pembaca.
            </p>
    ...
    <div class="container6">
        <div class="center-text" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
            <div class="left-text1">
                ...
                <h1 class="video">Tentang Makhfudzat Matsal</h1>
            </div>

            <div class="right-text1">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/ceaDtey_mNI?si=fJkCZMp__GtSSctK" width="500px" height="180px">
                </iframe>
            </div>
        </div>
    </div>
    ...
    <div class="tengah" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
        <h1>Contoh dari Makhfudzat Matsal</h1>
    </div>
