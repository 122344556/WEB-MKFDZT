...
<body>
    ...
    <div class="center-text" ">
        <div class=" left-text data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000"">
            <h1 class=" tengah">Makhfudzat motivasi hidup</h1>
    </div>

    <div class="right-text">
        <p>
        pada pemahaman mendalam atau kebijaksanaan yang terkait dengan motivasi hidup seseorang.
        Ini bisa mencakup pemahaman mendalam tentang makna hidup, tujuan hidup, atau nilai-nilai yang membimbing seseorang 
        dalam mencapai kebahagiaan dan pemenuhan pribadi.Perlu diingat bahwa istilah ini mungkin memiliki arti yang lebih 
        spesifik dalam suatu konteks tertentu atau dalam tradisi atau filosofi tertentu. Jika istilah ini digunakan dalam 
        suatu komunitas, kelompok, atau tradisi khusus, Anda mungkin perlu memahami konteks tersebut untuk mendapatkan interpretasi yang lebih akurat.
        </p>
    ...
    <div class="container6">
        <div class="center-text" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
            <div class="left-text1">
                ...
                <h1 class="video">Tentang Makhfudzat Motivasi</h1>
            </div>

            <div class="right-text1">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/4mnnHqhYL78?si=qoGOZCnmI6DdDdPk" width="500px" height="180px">
                </iframe>
            </div>
        </div>
    </div>
    ...
    <div class="tengah" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
        <h1>Contoh dari Makhfudzat Motivasi</h1>
    </div>
